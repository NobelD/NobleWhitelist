...
import me.nobeld.mc.noblewhitelist.logic.StorageLoader;
...
import me.nobeld.mc.noblewhitelist.storage.SQLDatabase;
import me.nobeld.mc.noblewhitelist.util.AdventureUtil;
import me.nobeld.mc.noblewhitelist.util.LibsManager;
...
public class NWLContainer {
    ...
    public static void closeData(NWLData data) {
        ...
        if (data.getStorageType().isDatabase()) {
            ((SQLDatabase)data.getStorage()).close();
        }
    ...
    public static class Builder {
        ...
        public Builder loadFiles() {
            ...
            AdventureUtil.replaceData(() -> config.usePrefix(), () -> config.getPrefix());
