...
@SuppressWarnings({"WeakerAccess", "unused", "deprecation", "TextBlockMigration"})
public class SpigotMetrics {
    ...
    public SpigotMetrics(JavaPlugin plugin, int serviceId) {
        ...
        metricsBase =
                new MetricsBase(
                        ...
                        submitDataTask -> SchedulerUtil.mainExecutor(plugin).execute(submitDataTask),
                        plugin::isEnabled,
     ...
     * for its use-case.
     */
    @SuppressWarnings({"UnusedReturnValue", "JavadocLinkAsPlainText", "UnnecessaryUnicodeEscape", "GrazieInspection"})
