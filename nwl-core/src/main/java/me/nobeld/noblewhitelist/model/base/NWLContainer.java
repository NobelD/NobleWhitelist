...
public class NWLContainer {
    ...
    public static class Builder {
        ...
        public Builder loadStorage(Function<String, ThreadFactory> threadCreator) {
            PairData<DataGetter, StorageType> st = new StorageLoader(data, config, threadCreator).setupStorage();
            storage = st.getFirst();
            type = st.getSecond();
            return this;
        }
