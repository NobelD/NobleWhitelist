...
import static me.nobeld.mc.noblewhitelist.config.FileManager.separator;

public class MessageData {
    private Yaml messagesFile = null;
    private void registerMessages() {
        Path configPath = Paths.get(NWLDiscord.getPlugin().getDataFolder().getPath() + separator() + "messages.yml");
    ...
    public String getMsg(ConfigContainer<String> cont) {
        return messageFile().get(cont.path(), cont.def());
    }
    public FlatFileSection getMsgSec(ConfigContainer<?> cont) {
