...
public class CMDDescription {
    ...
    public static Description generalAdmin() {
        return Description.of("Command for administrators to manage the whitelist.");
    }
    ...
    public static Description findUser() {
        return Description.of("Find a whitelisted user by their discord user.");
    }
    public static Description addUser() {
        return Description.of("Add a user to the whitelist.");
    }
    public static Description removeUser() {
        return Description.of("Remove an user from the whitelist.");
    }
    public static Description linkUser() {
        return Description.of("Link some data to a user.");
    }
    public static Description unlinkUser() {
        return Description.of("Unlink some data from a user.");
    }
    public static Description toggleUser() {
        return Description.of("Toggle if a user can join or not.");
    }
    public static Description entryList() {
        return Description.of("Get a list of the whitelist entries.");
    }
    public static Description whitelistOn() {
        return Description.of("Enable the whitelist.");
    }
    public static Description whitelistOff() {
        return Description.of("Disable the whitelist.");
    }
    public static Description permStatus() {
        return Description.of("Get the current status for the permission check.");
    }
    public static Description permSet() {
        return Description.of("Changes the limit for the permission check.");
    }
    ...
    public static Description checkingSet() {
        return Description.of("Change a whitelist check type.");
    }
    public static Description selfAccounts() {
        return Description.of("Get the accounts linked to you.");
    }
    public static Description selfAdd() {
        return Description.of("Register yourself to the whitelist");
    }
    public static Description selfRemove() {
        return Description.of("Remove yourself from the whitelist");
    }
